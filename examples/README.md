...
| [02-review-and-fix](02-review-and-fix/) | `code → review → fix` | artifacts between stages; `expects` | `duration` |
...
Each directory is **self-contained**: its `chain.yaml`, every prompt it uses, and a README explaining what that rung is for and how to run it. Nothing is shared between rungs except the graders under [`../fixtures/`](../fixtures/), which are the objective definition of done.
